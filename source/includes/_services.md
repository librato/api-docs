...
Each service is chosen from a set of supported back end services. The supported services are implemented in the [Librato Services](https://www.librato.com/docs/kb/alert/alerts-intro/#notification-services) Github repository. Users are encouraged to contribute new services.
...
type | The service type (e.g. Campfire, Pagerduty, mail, etc.). See an extensive list of [services here](https://www.librato.com/docs/kb/alert/alerts-intro/#notification-services).
