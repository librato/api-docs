...
role | The name of the role that encapsulates the permissions this token has. Must be one of: "admin", "recorder", or "viewer". See the [Knowledge Base Article](https://kb-docs-archive.librato.com/librato/account_management/tokens.html) for more details.
