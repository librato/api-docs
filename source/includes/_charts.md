...
downsample_function | This allows you to choose which statistic to use during [metric roll-ups](https://www.librato.com/docs/kb/visualize/faq/rollups_retention_resolution.html#roll-ups). If unset, defaults to "average". Valid options are one of: [max, min, average, sum, count].
